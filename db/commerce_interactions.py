...
commerce_interactions = Table(
    ...
    Column("checkout_id", String(64), nullable=True, index=True),
    Column("order_id", String(64), nullable=True, index=True),
    Column("refund_id", String(64), nullable=True, index=True),
    Column("return_id", String(64), nullable=True, index=True),
