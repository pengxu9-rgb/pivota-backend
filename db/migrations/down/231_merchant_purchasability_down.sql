...
-- MERCHANT_PURCHASABILITY_ENFORCE off, no consumer reads the table and dropping it changes
...
--
-- So: turn MERCHANT_PURCHASABILITY_ENFORCE OFF FIRST, confirm no consumer is reading, and only
