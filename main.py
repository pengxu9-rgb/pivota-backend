...
# from routes.test_data_routes import router as test_data_router  # File not in Git
...
# app.include_router(test_data_router)  # Test data for Lovable - File not in Git
