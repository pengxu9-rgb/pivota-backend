...
from routes.debug_commission_data import router as debug_commission_data_router
from routes.debug_generate_test_commissions import router as debug_generate_test_commissions_router
from routes.debug_ensure_commissions_table import router as debug_ensure_commissions_table_router
...
# [DISABLED] Phase 6 cleanup endpoint - has import errors (get_db_pool not in db.database)
# from routes.admin_cleanup_phase5_data import router as admin_cleanup_phase5_router
...
# [DISABLED] Phase 6 cleanup endpoint - has import errors
# app.include_router(admin_cleanup_phase5_router)
...
app.include_router(debug_commission_data_router)  # Debug commission data (temporary)
app.include_router(debug_generate_test_commissions_router)  # Debug generate test data (temporary)
app.include_router(debug_ensure_commissions_table_router)  # Debug ensure schema (temporary)
...
app.include_router(debug_shopify_api_router)  # Debug Shopify direct API test
