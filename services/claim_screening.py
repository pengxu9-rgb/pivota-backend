"""Cosmetic-vs-drug claim screening (K-beauty SKINCARE module).
...
Skincare lands first (cosmetic rules). Haircare reuses the shared cosmetic base
plus its own rules (regrows-hair / anti-dandruff) in the haircare module;
