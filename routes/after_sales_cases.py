    ...
    try:
        await database.execute(
            ...
            """,
            {
                ...
                "line_items_json": json.dumps([li.model_dump() for li in (req.line_items or [])]),
                "amount_breakdown_json": json.dumps(req.amount_breakdown.model_dump() if req.amount_breakdown else {}),
                "status": "requested",
                "label_url": None,
